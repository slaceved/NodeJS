...
function pieceParser (eq, unesc) {
  return function parsePiece (key, val) {
    ...
    // obj: key[subkey]=val
    var ret = {}; //eslint-disable-line block-scoped-var
    ret[tail] = val; //eslint-disable-line block-scoped-var
    return parsePiece(head, ret); //eslint-disable-line block-scoped-var
  };
};
